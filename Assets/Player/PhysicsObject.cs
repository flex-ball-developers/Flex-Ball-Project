...
public class PhysicsObject : MonoBehaviour {
    ...
    {
        //Overwritten in PlayerPlatformerController
    }
    ...
    void Movement(Vector2 _move, bool yMovement)
    {
        ...
        if(distance > minMoveDistance)
        {
            ...
            for(int i = 0; i < hitBufferList.Count; i++)
            {
                ...
                //If modifiedDistance is less than distance set distance to equal modDistance. Otherwise keep it as distance
        ...
        rb2d.position += _move.normalized * distance;
    }
}
